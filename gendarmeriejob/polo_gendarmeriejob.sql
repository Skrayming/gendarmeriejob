...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('gendarmerie',0,'recruit','Gendarme',20,'{}','{}'),
	('gendarmerie',1,'recruit','Maréchal des logis chef',20,'{}','{}'),
	('gendarmerie',2,'officer','Adjudent',40,'{}','{}'),
	('gendarmerie',3,'officer','Adjudent-Chef',40,'{}','{}'),
	('gendarmerie',4,'sergeant','Major',60,'{}','{}'),
	('gendarmerie',5,'lieutenant','Lieutenant',85,'{}','{}'),
	('gendarmerie',6,'lieutenant','Capitaine',85,'{}','{}'),
	('gendarmerie',7,'boss','Lieutenant Colonel',85,'{}','{}'),
	('gendarmerie',8,'boss','Colonel',100,'{}','{}')
;
